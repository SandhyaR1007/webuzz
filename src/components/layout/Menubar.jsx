...
const Menubar = () => {
  ...
  return (
    <ul className=" fixed bottom-0 xs:top-[4.75rem] flex  xs:flex-col justify-between xs:justify-start gap-0 xs:gap-10   py-5 px-3 xs:px-4 border xs:border-0 w-full xs:w-40  ">
      <li
        onClick={() => navigate("/")}
        className="flex items-center gap-4 border border-black rounded-full py-1 btn-shadow bg-[--blue-color] px-3"
      >
      ...
      <li
        ...
        className="flex items-center gap-4 border border-black rounded-full py-1 btn-shadow bg-[--pink-color] px-3"
      >
        {" "}
